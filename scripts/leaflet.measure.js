L.Control.Measure = L.Control.extend({
	...
	_mouseMove: function(e) {
		...
		if(this._tooltip) {
			...
			var distance = e.latlng.distanceToCRSSimple(this._lastPoint);
	...
	_mouseClick: function(e) {
		...
		if(this._lastPoint && this._tooltip) {
			...
			//var distance = e.latlng.distanceTo(this._lastPoint); console.log(e.latlng, distance)
			var distance = e.latlng.distanceToCRSSimple(this._lastPoint); console.log(e.latlng, distance)
			this._updateTooltipDistance(this._distance + distance, distance);

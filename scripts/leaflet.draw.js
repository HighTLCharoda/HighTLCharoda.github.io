  ...
  (L.drawVersion = "0.3.0-dev"),
    ...
    (L.Draw.Polyline = L.Draw.Feature.extend({
      ...
      _finishShape: function () {
        var t = this._poly.newLatLngIntersects(
            ...
            this._tooltip.updateContent({
              ...
              subtext: o
                ? L.drawLocal.draw.handlers.circle.radius +
                  ": " +
                  L.GeometryUtil.readableDistance(e, n, this.options.feet)
                : "",
            }));
      },
    })),
    ...
    (L.Edit.PolyVerticesEdit = L.Handler.extend({
      ...
      _spliceLatLngs: function () {
        ...
        return (
          this._poly._convertLatLngs(this._latlngs, !0), this._poly.redraw(), t
        );
      },
